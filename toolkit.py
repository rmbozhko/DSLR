...
def		computeThetas(X, y, gradDesc, h_func, computeCost, faculties, hyperparameters):
    ...
    [thetas, costs] = gradDesc(X, y, computeCost, h_func, thetas=thetas, learningRate=hyperparameters['alpha'], lambda_val=hyperparameters['lambda_val'], iterationsNum=hyperparameters['iterations'], batchSize=hyperparameters['batch_size'])
    return ([thetas, costs])
